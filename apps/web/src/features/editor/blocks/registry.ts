 ...
 *   3. 後端 block-types 加 validateProps
...
const SPECS: BlockSpec[] = [
  ...
  },
  {
    ...
    description: '建立一份簡單的清單',
    icon: 'list-bulleted',
    group: 'basic',
    keywords: ['bullet', 'list', 'ul', 'unordered', '清單', '項目', '無序', '點'],
    sortOrder: 50,
    defaultProps: {},
    canHaveChildren: true,
    hasInlineContent: true,
  ...
  },
  {
    ...
    description: '建立有順序的清單',
    icon: 'list-numbered',
    group: 'basic',
    keywords: ['number', 'ordered', 'ol', 'list', '編號', '有序', '清單', '數字'],
    sortOrder: 60,
    defaultProps: {},
    canHaveChildren: true,
    hasInlineContent: true,
  ...
  },
  {
    ...
    icon: 'file',
    group: 'media',
    keywords: ['file', 'attachment', 'upload', 'pdf', '檔案', '附件', '上傳'],
    sortOrder: 210,
