...
| `02b-page-mid` | 6.5 / 5.5% / 偏移 +1,+1 | 7.7 / 10.6% / 偏移 +1,+1 |
| `02c-page-mid2` | 24.4 / 28.3% / 偏移 +5,+6 | 19.0 / 20.5% / 偏移 +6,-6 |
| `02d-page-bottom` | 23.4 / 16.4% / 偏移 +1,+0 | 10.4 / 11.5% / 偏移 +1,+5 |
...
| `07-db-table-full` | 8.5 / 10.4% / 偏移 +6,+6 | 11.7 / 12.2% / 偏移 +1,+5 |
...
| `07e-db-board` | 6.3 / 6.5% / 偏移 +2,-2 | 7.1 / 6.3% / 偏移 +2,-2 |
| `07e-db-board-full` | 11.8 / 11.3% / 偏移 +1,+3 | 12.0 / 12.2% / 對齊 |
| `07f-db-list` | 5.0 / 5.9% / 偏移 +5,+0 | 6.6 / 7.0% / 偏移 +5,+0 |
| `07f-db-list-full` | 10.8 / 12.4% / 偏移 +6,-5 | 8.6 / 10.4% / 偏移 +6,+5 |
| `07g-db-gallery` | 5.1 / 3.8% / 偏移 +2,-4 | 11.9 / 4.2% / 偏移 +2,-2 |
| `07g-db-gallery-full` | 12.1 / 8.8% / 偏移 +0,+1 | 11.5 / 7.7% / 偏移 +0,+1 |
| `07h-db-calendar` | 3.6 / 4.9% / 偏移 +4,-3 | 4.1 / 5.1% / 偏移 +4,-4 |
| `07h-db-calendar-full` | 11.3 / 9.6% / 偏移 +1,+1 | 8.5 / 8.4% / 偏移 +0,+1 |
| `07i-db-timeline` | 4.6 / 5.3% / 偏移 +4,-3 | 4.8 / 4.4% / 偏移 +4,-3 |
| `07i-db-timeline-full` | 10.3 / 11.3% / 偏移 +5,-5 | 7.5 / 8.5% / 偏移 +1,+5 |
| `07k-db-filter` | 8.2 / 7.2% / 偏移 -6,+0 | 9.4 / 6.7% / 對齊 |
| `07l-db-sort` | 8.7 / 7.5% / 偏移 -6,+0 | 10.4 / 7.8% / 偏移 -6,+0 |
| `07m-db-settings` | 9.2 / 9.5% / 偏移 -6,+6 | 10.7 / 8.6% / 偏移 -6,+6 |
| `07n-db-view-tabs` | 7.0 / 8.0% / 偏移 +0,+2 | 8.4 / 8.2% / 偏移 +0,+2 |
