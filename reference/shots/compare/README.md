...
| 代號 | Light | Dark |
|---|---|---|
| `02-page-top` | 19.9 / 29.3% / 對齊 | 21.1 / 28.8% / 偏移 +5,+1 |
| `02b-page-mid` | 6.9 / 6.1% / 偏移 +1,+5 | 7.6 / 9.4% / 偏移 +1,+1 |
| `02c-page-mid2` | 25.0 / 28.9% / 偏移 +5,+6 | 19.4 / 20.9% / 偏移 +6,-6 |
| `02d-page-bottom` | 24.0 / 16.9% / 對齊 | 10.9 / 11.9% / 偏移 +0,+5 |
| `03e-sidebar-bottom` | 9.2 / 9.0% / 偏移 +1,+6 | 9.6 / 8.6% / 偏移 +1,+6 |
| `04-topbar` | 3.7 / 5.1% / 對齊 | 3.8 / 5.1% / 對齊 |
| `04b-topbar-right` | 7.3 / 9.5% / 偏移 +2,+0 | 7.3 / 9.5% / 偏移 +2,+0 |
| `04d-page-cover-icon` | 36.2 / 55.9% / 偏移 +5,+1 | 46.6 / 56.0% / 偏移 +5,+1 |
...
| `07-db-table` | 5.7 / 7.3% / 偏移 +4,+0 | 10.3 / 9.1% / 偏移 +2,+0 |
| `07-db-table-full` | 7.8 / 10.0% / 偏移 +6,+6 | 12.3 / 13.7% / 偏移 +0,+6 |
| `07b-db-header-hover` | 7.7 / 8.1% / 偏移 +2,+0 | 11.3 / 9.7% / 偏移 +3,+0 |
| `07c-db-row-hover` | 6.1 / 7.0% / 偏移 +5,+0 | 13.1 / 10.4% / 對齊 |
| `07d-db-cell-edit` | 7.0 / 7.9% / 偏移 +4,+0 | 13.3 / 13.2% / 偏移 +6,+0 |
...
| `07h-db-calendar` | 3.6 / 4.7% / 偏移 +4,-1 | 4.1 / 5.1% / 偏移 +4,-1 |
| `07h-db-calendar-full` | 11.3 / 9.2% / 偏移 +6,+5 | 8.3 / 8.8% / 偏移 +6,+6 |
| `07i-db-timeline` | 4.5 / 5.1% / 偏移 +4,-1 | 4.7 / 4.4% / 偏移 +2,-2 |
| `07i-db-timeline-full` | 10.1 / 11.6% / 偏移 +5,-6 | 6.9 / 8.8% / 偏移 +5,+6 |
| `07k-db-filter` | 7.1 / 6.5% / 對齊 | 8.2 / 5.8% / 對齊 |
| `07l-db-sort` | 7.5 / 6.6% / 對齊 | 9.0 / 6.9% / 對齊 |
| `07m-db-settings` | 7.5 / 8.5% / 偏移 -1,+0 | 8.7 / 7.7% / 對齊 |
| `07n-db-view-tabs` | 6.7 / 7.2% / 偏移 +0,+2 | 8.1 / 8.1% / 偏移 +0,+2 |
