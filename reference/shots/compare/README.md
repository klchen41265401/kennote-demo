...
| 代號 | Light | Dark |
|---|---|---|
| `02-page-top` | 19.4 / 28.8% / 對齊 | 20.6 / 28.4% / 偏移 +5,+1 |
| `02b-page-mid` | 6.4 / 5.6% / 偏移 -1,+0 | 7.9 / 10.9% / 偏移 +1,+0 |
| `02c-page-mid2` | 22.7 / 26.7% / 偏移 +5,+6 | 21.3 / 22.8% / 偏移 +6,-6 |
| `02d-page-bottom` | 23.4 / 16.4% / 偏移 +1,+0 | 10.5 / 12.0% / 偏移 +1,+5 |
...
| `04d-page-cover-icon` | 36.1 / 55.9% / 偏移 +5,+1 | 46.5 / 56.0% / 偏移 +6,+0 |
...
| `05-13-code` | 2.9 / 2.1% / 偏移 -1,+1 | 6.3 / 14.9% / 偏移 -1,-6 |
| `05-14-table` | 4.6 / 5.6% / 偏移 -5,-4 | 7.6 / 16.3% / 偏移 -2,-4 |
...
| `06-slash-menu-full` | 25.7 / 17.4% / 偏移 +1,+1 | 12.2 / 13.6% / 偏移 +1,-1 |
| `06f-block-hover` | 6.5 / 11.6% / 偏移 +1,+1 | 7.0 / 9.4% / 偏移 +2,+1 |
| `07-db-table` | 6.7 / 8.5% / 偏移 +4,-5 | 10.9 / 10.3% / 偏移 +2,-5 |
| `07-db-table-full` | 8.7 / 10.4% / 偏移 +5,+5 | 12.1 / 12.8% / 偏移 +1,+5 |
| `07b-db-header-hover` | 8.4 / 9.1% / 偏移 +2,+3 | 12.0 / 10.4% / 偏移 +2,+3 |
| `07c-db-row-hover` | 9.2 / 9.7% / 偏移 +4,-5 | 14.0 / 11.1% / 偏移 +0,-1 |
| `07d-db-cell-edit` | 10.1 / 10.2% / 偏移 +4,+0 | 15.1 / 12.8% / 偏移 +4,+0 |
| `07e-db-board` | 6.6 / 7.1% / 偏移 +2,-2 | 8.0 / 7.7% / 偏移 +2,-2 |
| `07e-db-board-full` | 11.8 / 11.5% / 偏移 +1,+3 | 11.2 / 11.1% / 偏移 +1,+5 |
| `07f-db-list` | 5.2 / 6.7% / 偏移 +4,-2 | 8.0 / 7.6% / 偏移 +4,-2 |
| `07f-db-list-full` | 10.7 / 12.5% / 偏移 +6,-5 | 8.8 / 10.6% / 偏移 +6,+5 |
| `07g-db-gallery` | 5.7 / 5.1% / 偏移 +2,-4 | 11.4 / 5.5% / 偏移 +2,-2 |
| `07g-db-gallery-full` | 12.2 / 9.2% / 偏移 +0,+1 | 11.7 / 8.1% / 偏移 +0,+1 |
| `07h-db-calendar` | 3.6 / 4.9% / 偏移 +4,-3 | 4.1 / 5.1% / 偏移 +4,-4 |
| `07h-db-calendar-full` | 11.2 / 9.6% / 偏移 +1,+1 | 8.5 / 8.5% / 偏移 +1,+1 |
| `07i-db-timeline` | 4.6 / 5.3% / 偏移 +4,-3 | 4.8 / 4.4% / 偏移 +4,-3 |
| `07i-db-timeline-full` | 10.3 / 11.3% / 偏移 +5,-5 | 7.6 / 8.5% / 偏移 +1,+5 |
| `07k-db-filter` | 9.1 / 8.8% / 偏移 -6,+0 | 10.3 / 8.4% / 對齊 |
| `07l-db-sort` | 9.8 / 9.4% / 偏移 -6,+0 | 11.5 / 9.9% / 偏移 -6,+0 |
| `07m-db-settings` | 9.2 / 9.5% / 偏移 -6,+6 | 10.7 / 8.8% / 偏移 -6,+6 |
| `07n-db-view-tabs` | 7.0 / 8.0% / 偏移 +0,+2 | 8.4 / 8.3% / 偏移 +0,+2 |
