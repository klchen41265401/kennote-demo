...
| 代號 | Light | Dark |
|---|---|---|
| `02-page-top` | 19.9 / 29.3% / 對齊 | 21.1 / 28.9% / 偏移 +5,+1 |
| `02b-page-mid` | 6.9 / 6.1% / 偏移 +1,+5 | 7.6 / 9.4% / 偏移 +1,+1 |
| `02c-page-mid2` | 25.0 / 28.9% / 偏移 +5,+6 | 19.5 / 20.9% / 偏移 +6,-6 |
| `02d-page-bottom` | 24.0 / 17.0% / 對齊 | 10.9 / 12.0% / 偏移 +0,+1 |
| `03e-sidebar-bottom` | 9.2 / 9.0% / 偏移 +1,+6 | 9.6 / 8.6% / 偏移 +1,+6 |
| `04-topbar` | 3.9 / 5.4% / 對齊 | 4.0 / 5.5% / 對齊 |
| `04b-topbar-right` | 8.3 / 11.0% / 偏移 +2,+0 | 8.1 / 10.9% / 偏移 +1,+0 |
| `04d-page-cover-icon` | 36.2 / 56.0% / 偏移 +5,+1 | 46.6 / 56.1% / 偏移 +5,+1 |
...
| `05-14-table` | 2.8 / 3.6% / 偏移 -5,+0 | 3.0 / 2.9% / 偏移 -5,+0 |
...
| `07-db-table` | 5.7 / 7.4% / 偏移 +2,+0 | 10.5 / 9.2% / 偏移 +4,+0 |
| `07-db-table-full` | 7.8 / 10.0% / 偏移 +6,+6 | 12.3 / 13.8% / 偏移 +0,+6 |
| `07b-db-header-hover` | 7.6 / 7.9% / 對齊 | 11.1 / 9.8% / 對齊 |
| `07c-db-row-hover` | 6.6 / 7.3% / 偏移 -1,+0 | 13.4 / 10.6% / 對齊 |
| `07d-db-cell-edit` | 6.6 / 7.6% / 偏移 +2,+0 | 13.1 / 12.4% / 偏移 +2,+0 |
| `07e-db-board` | 6.2 / 6.3% / 偏移 +2,+1 | 7.9 / 7.1% / 偏移 +2,+1 |
| `07e-db-board-full` | 11.7 / 11.3% / 偏移 +5,+6 | 11.4 / 12.1% / 偏移 +6,+6 |
| `07f-db-list` | 5.2 / 5.9% / 偏移 +5,+5 | 6.9 / 7.2% / 偏移 +5,+5 |
| `07f-db-list-full` | 10.6 / 13.0% / 偏移 +6,-6 | 8.0 / 11.3% / 偏移 +6,+6 |
| `07g-db-gallery` | 4.8 / 3.5% / 偏移 +2,+1 | 6.8 / 3.1% / 偏移 +5,+0 |
| `07g-db-gallery-full` | 12.4 / 8.4% / 偏移 +0,+6 | 12.3 / 7.3% / 偏移 +6,+6 |
| `07h-db-calendar` | 3.6 / 4.7% / 偏移 +4,-1 | 4.2 / 5.1% / 偏移 +4,-1 |
| `07h-db-calendar-full` | 11.4 / 9.2% / 偏移 +6,+5 | 8.4 / 8.8% / 偏移 +6,+6 |
| `07i-db-timeline` | 4.6 / 5.1% / 偏移 +4,-1 | 4.8 / 4.4% / 偏移 +2,-2 |
| `07i-db-timeline-full` | 10.1 / 11.6% / 偏移 +5,-6 | 7.0 / 8.8% / 偏移 +5,+6 |
| `07k-db-filter` | 7.9 / 7.1% / 對齊 | 9.2 / 7.3% / 對齊 |
| `07l-db-sort` | 7.1 / 6.3% / 對齊 | 8.4 / 6.4% / 對齊 |
| `07m-db-settings` | 7.7 / 8.7% / 偏移 -1,+0 | 9.2 / 8.4% / 對齊 |
| `07n-db-view-tabs` | 6.7 / 7.2% / 偏移 +0,+2 | 8.0 / 8.0% / 偏移 +0,+2 |
